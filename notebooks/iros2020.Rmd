...
# If -2 * X = 0, then X = 0; and vice versa
...
hyp_to_test = c(common_hyp_to_test, noise_levels_hyp_to_test)
hyp_results = hypothesis(scenario_completed.model.v,
                         hypothesis = c(hyp_to_test, noise_levels_hyp_to_test),
                         seed = default_seed)
print(as_tibble(hyp_results$hypothesis))
plot(hyp_results, ask = F, ignore_prior = T)
