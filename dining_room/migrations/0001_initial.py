# Generated by Django 3.0.2 on 2020-01-24 22:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('will_view_in_first_person', models.BooleanField(blank=True, null=True, verbose_name="You will see a first-person view from the robot's camera in the event of an error?")),
                ('supposed_to_select_only_one_error', models.BooleanField(blank=True, null=True, verbose_name="When asked to indicate what's wrong, you can only select 1 error?")),
